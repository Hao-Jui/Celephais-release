...
namespace Kadath
{
    ...
    class Domain_shell_inner_adapted_nosym : public Domain
    {
      ...
      public:
        Domain_shell_inner_adapted_nosym(const Space& sp, int num, int ttype, double rin, double rout, const Point& cr,
                                   const Dim_array& nbr);

        Domain_shell_inner_adapted_nosym(const Space& sp, int num, int ttype, const Val_domain& rin, double rout,
                                   const Point& cr, const Dim_array& nbr);
        Domain_shell_inner_adapted_nosym(const Domain_shell_inner_adapted_nosym& so);

        Domain_shell_inner_adapted_nosym(const Space& sp, int num, BinarySource& source); ///< Modern API.

        ~Domain_shell_inner_adapted_nosym() override;
      ...
      protected:
        ...
        void affecte_coef_lane(int&, int, int, int, bool&) const;
        void restore_scalar_derivative_lanes() const;
        ...
        void accumulate_term_eq_mapping_derivative(Term_eq*) const override;
        void update_term_eq_impl(Term_eq*, bool accumulate) const;
      ...
      public:
        ...
        void export_tau_val_domain_boundary(const Val_domain& eq, int mlim, int bound, Array<double>& res, int& pos_res,
                                            int ncond) const;
        void export_tau_val_domain_boundary_matching(const Val_domain& eq, int mlim, int bound, Array<double>& res,
    ...
    class Domain_shell_outer_adapted_nosym : public Domain
    {
      ...
      public:
        Domain_shell_outer_adapted_nosym(const Space& sp, int num, int ttype, double rin, double rout, const Point& cr,
                                   const Dim_array& nbr);

        Domain_shell_outer_adapted_nosym(const Space& sp, int num, int ttype, double rin, const Val_domain& rout,
                                   const Point& cr, const Dim_array& nbr);
        Domain_shell_outer_adapted_nosym(const Domain_shell_outer_adapted_nosym& so);

        Domain_shell_outer_adapted_nosym(const Space& sp, int num, BinarySource& source); ///< Modern API.

        ~Domain_shell_outer_adapted_nosym() override;
        void del_deriv() const override;
        void save(BinarySink&) const override; ///< Modern API.
    ...
    class Space_spheric_adapted_nosym : public Space
    {
      public:
        Space_spheric_adapted_nosym(int ttype, const Point& cr, const Dim_array& nbr, const Array<double>& bounds);
        Space_spheric_adapted_nosym(int ttype, const Point& cr, const Dim_array& nbr, const std::vector<double>& bounds);
        Space_spheric_adapted_nosym(BinarySource&); ///< Modern API.
        ~Space_spheric_adapted_nosym() override;
        void save(BinarySink&) const override; ///< Modern API.
