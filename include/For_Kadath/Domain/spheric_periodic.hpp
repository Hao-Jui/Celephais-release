    ...
    */
    class Domain_spheric_periodic_nucleus : public Domain
    {
      ...
      private:
         ...
         * \li if 1 \f$ t^*\f$ goes to \f$ pi/2\f$.
         */
        int type_time;
      ...
      public:
        ...
        Domain_spheric_periodic_nucleus(const Domain_spheric_periodic_nucleus& so); ///< Copy constructor.
                                                                                     ...
                                                                                     */
        Domain_spheric_periodic_nucleus(int num, BinarySource& source); ///< Modern API.

        ~Domain_spheric_periodic_nucleus() override;
      ...
      public:
        ...
        Val_domain ddtime(const Val_domain&) const override;
    ...
    /**
    * Class for a 2-dimensional spherical domain bounded between two fixed radii and a symetry with respect to the plane
    \f$ z=0 \f$.
    * The second dimension is the time that is periodic.
    * Time can have two possible behaviors where the numerical time goes either to \f$pi\f$ or to \f$pi/2\f$.
    * In the first case standard fields are expanded onto cosines functions and onto even cosines in the second one.
    ...
    */
    class Domain_spheric_periodic_shell : public Domain
    {
      ...
      public:
         ...
         * @param nbr : number of points in each dimension.
         */
        Domain_spheric_periodic_shell(int num, int ttype, int typet, double r_int, double r_ext, double ome,
                                      const Dim_array& nbr);
        Domain_spheric_periodic_shell(const Domain_spheric_periodic_shell& so); ///< Copy constructor.
                                                                                 ...
                                                                                 * @param ff: file containd the domain, generated by the save function.
                                                                                 */
        Domain_spheric_periodic_shell(int num, BinarySource& source); ///< Modern API.

        ~Domain_spheric_periodic_shell() override;
        void save(BinarySink&) const override; ///< Modern API.
      ...
      public:
        ...
        /**
         * Computes the coefficient of a given outgoing wave harmonique inside some field, at the outer boundary of the
         * domain.
        ...
        /**
         * Computes the coefficient of a given outgoing wave harmonique inside some field, at the outer boundary of the
         * domain. Case of a field coupled to gravity.
         * @param so : the field to be fitted.
         ...
         * @returns : the amplitude of the wave.
         */
        double give_harmonique_nonflat(const Val_domain& so, double mass, int nn, double phase, int dim,
                                       double fact) const;
        /**
         * Fit some field with homogenous solutions of the wave equation (\c Term_eq version).
         ...
         * @returns : the fit, being a sum of outgoing waves.
         */
        Term_eq fitwaves_nonflat(const Term_eq& so, const Term_eq& field, const Array<double>& phases, int dim,
                                 double factor) const;
    ...
    */
    class Domain_spheric_periodic_compact : public Domain
    {
      ...
      public:
         ...
         * @param ff: file containd the domain, generated by the save function.
         */
        Domain_spheric_periodic_compact(int num, BinarySource& source); ///< Modern API.

        ~Domain_spheric_periodic_compact() override;
        void save(BinarySink&) const override; ///< Modern API.
    ...
    class Space_spheric_periodic : public Space
    {
      ...
      public:
        ...
        Space_spheric_periodic(BinarySource&); ///< Modern API.
        ~Space_spheric_periodic() override;
        void save(BinarySink&) const override; ///< Modern API.
         ...
         * @param pused : pointer on the indexes of the components to be considered. Not used of nused = -1 .
         */
        void add_eq_inverted(System_of_eqs& syst, const char* eq, const char* rac, const char* rac_der, int nused = -1,
                             Array<int>** pused = nullptr);
        /**
