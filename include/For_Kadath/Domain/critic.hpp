...
namespace Kadath
{
    ...
    */
    class Domain_critic_inner : public Domain
    {
      ...
      protected:
        ...
        double xlim;             ///< Relates the numerical \f$ X^* \f$ to the \f$ X\f$ variable.
      ...
      public:
        ...
        Domain_critic_inner(const Domain_critic_inner& so); ///< Copy constructor.
                                                             ...
                                                             */
        Domain_critic_inner(int num, BinarySource& source); ///< Modern API.

        ~Domain_critic_inner() override;
      ...
      private:
        ...
        void set_cheb_xodd_base(Base_spectral& so) const override;
        void set_legendre_xodd_base(Base_spectral&) const override;
        void set_cheb_todd_base(Base_spectral& so) const override;
        void set_legendre_todd_base(Base_spectral&) const override;
        void set_cheb_xodd_todd_base(Base_spectral& so) const override;
        void set_legendre_xodd_todd_base(Base_spectral&) const override;
      ...
      public:
        Val_domain get_X() const override;
        Val_domain get_T() const override;
    ...
    */
    class Domain_critic_outer : public Domain
    {
      ...
      public:
        ...
        Domain_critic_outer(const Domain_critic_outer& so); ///< Copy constructor.
                                                             ...
                                                             * @param ff: file containd the domain, generated by the save function.
                                                             */
        Domain_critic_outer(int num, BinarySource& source); ///< Modern API.

        ~Domain_critic_outer() override;
        void del_deriv() const override;
        void save(BinarySink&) const override; ///< Modern API.
    ...
    /**
     * The \c Space_critic ; set the space with two critic domains, separated at \f$ x_{lim}\f$.
     * \ingroup domain
     */
    class Space_critic : public Space
    {
      public:
        ...
        Space_critic(BinarySource&); ///< Modern API.
        ~Space_critic() override;
        void save(BinarySink&) const override; ///< Modern API.
         ...
         */
        void add_bc_zero(System_of_eqs& syst, const char* eq, int nused = -1, Array<int>** pused = nullptr);
        /**
         ...
         * @param pused : pointer on the indexes of the components to be considered. Not used of nused = -1 .
         */
        void add_bc_one(System_of_eqs&, const char*, int nused = -1, Array<int>** pused = nullptr);
        /**
         * Adds an equation saying that one coefficient of a field is zero (at \f$ x_{lim}\f$)
         * @param syst : the \c System_of_eqs.
         * @param f : the field
