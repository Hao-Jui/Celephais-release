...
#include "spheric_adapted_nosym.hpp"

namespace Kadath
{
    /**
     * Class for a spherical-like domain, without symmetry with respect to the plane \f$ z=0 \f$.
     * \li 3 dimensions.
     ...
     * \ingroup domain
     */
    class Domain_shell_inner_homothetic_nosym : public Domain_shell_inner_adapted_nosym
    {
      ...
      public:
         ...
         */
        Domain_shell_inner_homothetic_nosym(const Space& sp, int num, int ttype, double rin, double rout, const Point& cr,
                                            const Dim_array& nbr);
        Domain_shell_inner_homothetic_nosym(const Domain_shell_inner_homothetic_nosym& so); ///< Copy constructor.
                                                                                           /**
                                                                                            ...
                                                                                            */
        Domain_shell_inner_homothetic_nosym(const Space& sp, int num, BinarySource& source); ///< Modern API.

        ~Domain_shell_inner_homothetic_nosym() override;
     ...
     * \ingroup domain
     */
    class Domain_shell_outer_homothetic_nosym : public Domain_shell_outer_adapted_nosym
    {
      ...
      public:
         ...
         * @param nbr [nbr] : number of points in each dimension.
         */
        Domain_shell_outer_homothetic_nosym(const Space& sp, int num, int ttype, double rin, double rout, const Point& cr,
                                            const Dim_array& nbr);
        Domain_shell_outer_homothetic_nosym(const Domain_shell_outer_homothetic_nosym& so); ///< Copy constructor.
                                                                                           /**
                                                                                            * Constructor from a file
                                                                                            * @param sp [input] : the associated \c Space.
                                                                                            * @param num : number of the domain (used by the \c Space).
                                                                                            ...
                                                                                            */
        Domain_shell_outer_homothetic_nosym(const Space& sp, int num, BinarySource& source); ///< Modern API.

        ~Domain_shell_outer_homothetic_nosym() override; ///< Destructor
