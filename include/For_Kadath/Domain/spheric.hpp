...
namespace Kadath
{
    ...
    class Domain_nucleus : public Domain
    {
      ...
      public:
         ...
         */
        Domain_nucleus(int num, BinarySource& source); ///< Modern API.

        ~Domain_nucleus() override;
      ...
      private:
         ...
         * The bases are :
         * \li \f$ cos(mvarphi^*)\f$ and \f$ sin(mvarphi^*)\f$ .
         * \li \f$ cos((2j)theta^*)\f$ for \f$ m \f$ even (\f$ l = 2j \f$)
         * and \f$ sin((2j+1) theta^*)\f$ for \f$ m \f$ odd (\f$ l = 2j+1 \f$).
         ...
         * The bases are :
         * \li \f$ cos(mvarphi^*)\f$ and \f$ sin(mvarphi^*)\f$ .
         * \li \f$ cos((2j+1)theta^*)\f$ for \f$ m \f$ even (\f$ l = 2j+1 \f$)
         * and \f$ sin((2j) theta^*)\f$ for \f$ m \f$ odd (\f$ l = 2j \f$).
        ...
        void set_cheb_base_r_mtz(Base_spectral&) const override;
        void set_cheb_base_t_mtz(Base_spectral&) const override;
        void set_cheb_base_p_mtz(Base_spectral&) const override;
        ...
        void set_legendre_base_r_mtz(Base_spectral&) const override;
        void set_legendre_base_t_mtz(Base_spectral&) const override;
        void set_legendre_base_p_mtz(Base_spectral&) const override;
      ...
      public:
        ...
        /**
         * Computes the number of true unknowns of a \c Val_domain.
         * Intended for the \f$theta\f$ component of a vector.
         * @param so : the field.
         * @returns the number of true unknowns.
         */
         ...
         * It takes into account the various Galerkin basis used.
         * It is used for implementing boundary conditions and matching ones.
         * Intended for a \f$theta\f$ component of a vector.
         * @param eq : the residual of the equation.
         * @returns the number of true conditions.
         */
         ...
         */
        void export_tau_val_domain(const Val_domain& eq, int mlim, int llim, int order, Array<double>& res,
         ...
         * @param ncond :  the corresponding number of equations. It is used when the equation is null.
         */
        void export_tau_val_domain_vr(const Val_domain& eq, int order, Array<double>& res, int& pos_res,
                                      int ncond) const;
        /**
         * Exports a residual equation in the bulk.
         * It makes use of the various Galerkin basis used.
         ...
         * @param ncond :  the corresponding number of equations. It is used when the equation is null.
         */
        void export_tau_val_domain_vt(const Val_domain& eq, int order, Array<double>& res, int& pos_res,
                                      int ncond) const;
        /**
         * Exports a residual equation in the bulk.
         * It makes use of the various Galerkin basis used.
         ...
         * @param ncond :  the corresponding number of equations. It is used when the equation is null.
         */
        void export_tau_val_domain_vp(const Val_domain& eq, int order, Array<double>& res, int& pos_res,
                                      int ncond) const;
         ...
         * @param ncond :  the corresponding number of equations. It is used when the residual is null.
         */
        void export_tau_val_domain_boundary_vr(const Val_domain& eq, int bound, Array<double>& res, int& pos_res,
                                               int ncond) const;
        /**
         * Exports all the residual equations corresponding to a tensorial one on a given boundary
         * It makes use of the various Galerkin basis used.
         * Intended for the radial component of a vector/
         * @param eq : the \f$theta\f$ of the equation.
         * @param bound : the boundary at which the equation is enforced.
         * @param res : The \c Array where the discretized equations are stored.
         * @param pos_res : current position in res.
         * @param ncond :  the corresponding number of equations. It is used when the residual is null.
         */
        void export_tau_val_domain_boundary_vt(const Val_domain& eq, int bound, Array<double>& res, int& pos_res,
                                               int ncond) const;
        /**
         * Exports all the residual equations corresponding to a tensorial one on a given boundary
         * It makes use of the various Galerkin basis used.
         ...
         * @param ncond : the corresponding number of equations. It is used when the residual is null.
         */
        void export_tau_val_domain_boundary_vp(const Val_domain& eq, int bound, Array<double>& res, int& pos_res,
                                               int ncond) const;
    ...
    class Domain_shell : public Domain
    {
      ...
      public:
        ...
        Domain_shell(const Domain_shell& so); ///< Copy constructor.
                                               ...
                                               * @param ff: file containd the domain, generated by the save function.
                                               */
        Domain_shell(int num, BinarySource& source); ///< Modern API.

        ~Domain_shell() override;
        void save(BinarySink&) const override; ///< Modern API.
      ...
      public:
        ...
        /**
         * Computes the numerical coordinates from the physical ones.
         * \li \f$ x = \frac{sqrt((X-X_c)^2+(Y-Y_c)^2+(Z-Z_c)^2)-beta}{alpha} \f$
         * \li \f$ theta^* = {atan} (\frac{sqrt((X-X_c)^2+(Y-Y_c)^2)}{Z-Z_c}) \f$
         * \li \f$ varphi^* = {atan} (Y-Y_c/Z-Z_c) \f$
         * @param xxx [input] : the absolute Cartesian \f$ (X, Y, Z) \f$ coordinates of the point.
         * @returns the numerical coordinates \f$ (x, theta^*, varphi^*) \f$.
      ...
      public:
        ...
        double multipoles_sym(int, int, int, const Val_domain&, const Array<double>&) const override;
        double multipoles_asym(int, int, int, const Val_domain&, const Array<double>&) const override;

        Term_eq multipoles_sym(int, int, int, const Term_eq&, const Array<double>&) const override;
        Term_eq multipoles_asym(int, int, int, const Term_eq&, const Array<double>&) const override;

        Term_eq radial_part_sym(const Space&, int, int, const Term_eq&,
                                        Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&),
                                        const Param&) const override;
        Term_eq radial_part_asym(const Space&, int, int, const Term_eq&,
                                         Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&),
                                         const Param&) const override;
        Term_eq harmonics_sym(const Term_eq&, const Term_eq&, int,
                                      Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&), const Param&,
                                      const Array<double>&) const override;
        Term_eq harmonics_asym(const Term_eq&, const Term_eq&, int,
                                       Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&), const Param&,
                                       const Array<double>&) const override;

        Term_eq der_radial_part_sym(const Space&, int, int, const Term_eq&,
                                            Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param& param),
                                            const Param&) const override;
        Term_eq der_radial_part_asym(const Space&, int, int, const Term_eq&,
                                             Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&),
                                             const Param&) const override;
        Term_eq der_harmonics_sym(const Term_eq&, const Term_eq&, int,
                                          Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&),
                                          const Param&, const Array<double>&) const override;
        Term_eq der_harmonics_asym(const Term_eq&, const Term_eq&, int,
                                           Term_eq (*f)(const Space&, int, int, const Term_eq&, const Param&),
                                           const Param&, const Array<double>&) const override;
        Term_eq der_multipoles_sym(int, int, int, const Term_eq&, const Array<double>&) const override;
        Term_eq der_multipoles_asym(int, int, int, const Term_eq&, const Array<double>&) const override;
         ...
         * @param ncond : the corresponding number of equations. It is used when the residual is null.
         */
        void export_tau_val_domain_boundary(const Val_domain& eq, int mlim, int bound, Array<double>& res,
                                            int& pres_res, int ncond) const;
        void affecte_tau(Tensor&, int, const Array<double>&, int&) const override;
        /**
         * Affects some coefficients to a \c Val_domain.
         * It takes into account the various symmetries and regularity conditions (by means of Garlekin basis).
         ...
         * @returns the number of true conditions.
         */
        void export_tau_val_domain_boundary_exception(const Val_domain& so, int mlim, int bound, Array<double>& res,
        ...
        Term_eq derive_flat_spher(int, char, const Term_eq&, const Metric*) const override;
        Term_eq derive_flat_cart(int, char, const Term_eq&, const Metric*) const override;
        Term_eq derive_flat_mtz(int, char, const Term_eq&, const Metric*) const override;
        double integ(const Val_domain& so, int bound) const override;
    ...
    class Domain_compact : public Domain
    {
      ...
      public:
        ...
        Domain_compact(const Domain_compact& so); ///< Copy constructor.
                                                   ...
                                                   * @param ff: file containd the domain, generated by the save function.
                                                   */
        Domain_compact(int num, BinarySource& source); ///< Modern API.

        ~Domain_compact() override;
        void save(BinarySink&) const override; ///< Modern API.
      ...
      public:
        Point get_center() const override { return center; }; ///< Returns the center ;
        ...
        /**
         * Computes the numerical coordinates from the physical ones.
         * \li \f$ x = 1 + 1/alphasqrt((X-X_c)^2+(Y-Y_c)^2+(Z-Z_c)^2) \f$
         * \li \f$ theta^* = {atan} (\frac{sqrt((X-X_c)^2+(Y-Y_c)^2)}{Z-Z_c}) \f$
         * \li \f$ varphi^* = {atan} (Y-Y_c/Z-Z_c) \f$
         * @param xxx [input] : the absolute Cartesian \f$ (X, Y, Z) \f$ coordinates of the point.
         * @returns the numerical coordinates \f$ (x, theta^*, varphi^*) \f$.
         ...
         * Computes the derivative with respect to the absolute Cartesian coordinates from the
         * derivative with respect to the numerical coordinates.
         * \li \f$ rpartial f/partial X =
         *		(-sin(theta) (x-1) partial f/partial x +
         *	cos(theta) partial f/rpartial theta^*) cos(varphi)
         * - sin(varphi) partial f/rsin(theta) partial varphi^* \f$
         * \li \f$ rpartial f/partial Y =
         *		(-sin(theta) (x-1) partial f/partial x +
         *	cos(theta) partial f/rpartial theta^*) sin(varphi)
         * + cos(varphi) partial f/rsin(theta) partial varphi^* \f$
         * \li \f$ rpartial f/partial Z =
         * -cos(theta) (x-1) partial f/partial x
         * - sin(theta)partial f/rpartial theta^*\f$
         * @param der_var [input] : the \c ndim derivatives with respect to the numerical coordinates.
         * @param der_abs [output] : the \c ndim derivatives with respect to the absolute Cartesian coordinates.
         */
    ...
    /**
     * The \c Space_spheric class fills the space with one nucleus, several shells and a compactified domain, all
    ...
    class Space_spheric : public Space
    {
      public:
        ...
        /**
         * Standard constructor that allows some shells to be of diffent type (\c Domain_shell_log or \c
         * Domain_shell_surr)
         * @param ttype [input] : the type of basis.
         * @param cr [input] : absolute coordinates of the center.
         * @param nbr [input] : number of points in each domain.
        ...
        Space_spheric(BinarySource&, bool withzec = true); ///< Modern API.
        ~Space_spheric() override;                  ///< Destructor
        void save(BinarySink&) const override; ///< Modern API.
         ...
         */
        void add_inner_bc(System_of_eqs& syst, const char* eq, int nused = -1, Array<int>** pused = nullptr);
         ...
         * @param pused : pointer on the indexes of the components to be considered. Not used of nused = -1 .
         */
        void add_outer_bc(System_of_eqs& syst, const char* eq, int nused = -1, Array<int>** pused = nullptr);
         ...
         * @param pused : pointer on the indexes of the components to be considered. Not used of nused = -1 .
         */
        void add_matching(System_of_eqs& syst, const char* eq, int nused = -1, Array<int>** pused = nullptr);
         ...
         * @param jtarget : the index \f$theta\f$ of the mode that must vanish.
    ...
    class Domain_shell_log : public Domain_shell
    {
      ...
      public:
        ...
        Domain_shell_log(const Domain_shell_log& so); ///< Copy constructor.
                                                       ...
                                                       * @param ff: file containd the domain, generated by the save function.
                                                       */
        Domain_shell_log(int num, BinarySource& source); ///< Modern API.

        ~Domain_shell_log() override;
        void save(BinarySink&) const override; ///< Modern API.
    ...
    class Domain_shell_surr : public Domain_shell
    {
      ...
      public:
        ...
        Domain_shell_surr(const Domain_shell_surr&); ///< Copy constructor.
                                                      ...
                                                      * @param ff: file containd the domain, generated by the save function.
                                                      */
        Domain_shell_surr(int num, BinarySource& source); ///< Modern API.

        ~Domain_shell_surr() override;
        void save(BinarySink&) const override; ///< Modern API.
      ...
      public:
        double get_rmin() const override { return 1. / (beta - alpha); };
        double get_rmax() const override { return 1. / (beta + alpha); };
