...
class ns_2d_xcts_diff_solver : public Solver<config_t, space_t>
{
  public:
  ...
  public:
    ns_2d_xcts_diff_solver() = delete;
    ns_2d_xcts_diff_solver(config_t& config_in, space_t& space_in, Scalar& conf_in, Scalar& lapse_in, Scalar& logh_in,
                           Scalar& shift_in, Scalar& Omg_in);
...
inline int ns_2d_xcts_driver(config_t& bconfig, std::string outputdir,
                             std::string initial_basename = "initns");


} // namespace Kadath
#include "lifting.hpp"
#include "solver_imp.ipp"
#include "uniform_rot_stage.ipp"
#include "driver.ipp"
