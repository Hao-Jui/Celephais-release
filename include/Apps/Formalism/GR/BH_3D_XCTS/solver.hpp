...
class bh_3d_xcts_solver : public XCTS_Solver<config_t, space_t>
{
  ...
  public:
    ...
    bh_3d_xcts_solver(config_t& config_in, space_t& space_in, Base_tensor& base_in, Scalar& conf_in, Scalar& lapse_in,
                      Vector& shift_in);
...
template <typename config_t>
inline int bh_3d_xcts_bin_boost_driver(config_t& bconfig, kadath_config<BIN_INFO> binconfig, NODES bco);
