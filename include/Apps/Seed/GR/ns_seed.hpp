#pragma once
// ObjectSeeder specialization: isolated neutron star, symmetric spherical space, GR.
#include "../seed_traits.hpp"
#include "Hydro/EOS.hh"
#include "../tov_utils.hpp"
#include "../seed_utils.hpp"
#include "For_Kadath/Kadath_point_h/kadath_adapted.hpp"   // Space_spheric_adapted
...
template <>
struct ObjectSeeder<NS, Space_spheric_adapted, GR> : detail::SphericalNsSeeder<Space_spheric_adapted> {};

template <>
struct ObjectSeeder<NS, Space_spheric_homothetic, GR> : detail::SphericalNsSeeder<Space_spheric_homothetic> {};
