#pragma once
// ObjectSeeder specialization: isolated black hole, nosym adapted-BH space, GR.
#include "../seed_traits.hpp"
#include "bh_seed_utils.hpp"
#include "For_Kadath/Kadath_point_h/kadath_adapted_bh_nosym.hpp" // Space_adapted_bh_nosym
...
template <>
struct ObjectSeeder<BH, Space_adapted_bh_nosym, GR> {
    ...
    static void execute(config_t& bconfig, bool use_config_vars = false)
    {
        ...
        Space_adapted_bh_nosym space(type_coloc, center, res, bounds);
