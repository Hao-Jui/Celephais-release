...
namespace Kadath
{
        ...
        do {
            ...
            switch (baset) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow theta basis in Domain_shell::nbr_conditions_val_domain");
            }
    ...
    Array<int> Domain_shell::nbr_conditions(const Tensor& tt, int dom, int order, int n_cmp, Array<int>** p_cmp) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_shell::nbr_conditions");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_shell::nbr_conditions");
                }
            } break;
            default:
    ...
    bool Domain_shell::describe_volume_residual_rows(
