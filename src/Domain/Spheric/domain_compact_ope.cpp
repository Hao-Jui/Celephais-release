        ...
        do {
            switch ((*so.base.bases_1d[1])(index_t)) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown case in Domain_compact::mult_cos_phi");
            }
        } while (index_t.inc());
        ...
        do {
            switch ((*so.base.bases_1d[1])(index_t)) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown case in Domain_compact::mult_sin_phi");
            }
        } while (index_t.inc());
        *res.base.bases_1d[0] = *so.base.bases_1d[0];
    ...
    Val_domain Domain_compact::der_partial_var(const Val_domain& so, int which_var) const
    {
        ...
        switch (which_var) {
            ...
            case 2:
                return so.der_var(3);
            default:
                KADATH_THROW("Unknown variable in Domain_compact::der_partial_var");
        }
    }
