...
namespace Kadath
{
    Term_eq Domain_nucleus::derive_flat_spher(int type_der, char ind_der, const Term_eq& so,
    ...
    Term_eq Domain_nucleus::derive_flat_cart(int type_der, char ind_der, const Term_eq& so,
                                             const Metric* manipulator) const
    {
