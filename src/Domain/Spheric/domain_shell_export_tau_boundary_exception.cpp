...
namespace Kadath
{
    void Domain_shell::export_tau_val_domain_boundary_exception(const Val_domain& so, int mlim, int bound,
                    ...
                    for (int j = 0; j < nbr_coefs(1); j++) {
                        ...
                        switch (baset) {
                            ...
                            case SIN_ODD:
                                ...
                                break;
                            default:
                                KADATH_THROW("Unknow theta basis in Domain_shell::export_tau_val_domain_boundary_exception");
                        }
                    }
                }
        }
    ...
    void Domain_shell::export_tau_boundary_exception(const Tensor& tt, int dom, int bound, Array<double>& res,
                                                     ...
                                                     Array<int>** p_cmp) const
    {
        ...
        if ((bound != INNER_BC) && (bound != OUTER_BC)) {
            KADATH_THROW("Unknown boundary_exception in Domain_shell::export_tau_boundary_exception");
        }
