...
namespace Kadath
{
    Term_eq Domain_shell_inner_adapted_nosym::derive_flat_spher(int type_der, char ind_der, const Term_eq& so,
                    ...
                    case 1:
                        ...
                        switch (pos_auxi(ind_sum + 1)) {
                            ...
                            case 2:
                                ...
                                break;
                            default:
                                KADATH_THROW("Bad indice in Domain_shell_inner_adapted_nosym::derive_flat_spher");
                        }
                        break;
                    case 2:
                        // Dphi
    ...
    Term_eq Domain_shell_inner_adapted_nosym::derive_flat_cart(int type_der, char ind_der, const Term_eq& so,
                                                         const Metric* manipulator) const
    {
        ...
        if (doder && need_sum && contraction_index >= 0 && so.val_t->get_valence() <= 2 &&
            ...
            auto cartesian_component = [this](const Tensor& radial, const Tensor& theta, const Tensor& phi,
                ...
                switch (axis) {
                    ...
                    default:
                        KADATH_THROW("Bad Cartesian axis in Domain_shell_inner_adapted_nosym::derive_flat_cart");
                }
            };
