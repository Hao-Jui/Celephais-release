...
namespace Kadath
{
    void Domain_critic_inner::find_other_dom(int dom, int bound, int& other_dom, int& other_bound) const
    {
        ...
        switch (bound) {
            case OUTER_BC:
                ...
                break;
            default:
                KADATH_THROW("Unknown boundary case in Domain_critic_inner::find_other_dom");
        }
    }
        ...
        if (so.check_if_zero())
            ...
            switch (bound) {
                        ...
                        for (int i = 0; i < nbr_coefs(0); i++) {
                            ...
                            switch (base_r) {
                                ...
                                case LEG_EVEN:
                                    ...
                                    break;
                                default:
                                    KADATH_THROW("Unknown basis type in Domain_critic_inner::val_boundary");
                            }
                        }
                    }
                    break;
                case OUTER_BC:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown boundary type in Domain_critic_inner::val_boundary");
            }
            return res;
        }
    }
    ...
    int Domain_critic_inner::nbr_points_boundary(int bound, const Base_spectral& bb) const
    {
        ...
        if ((bound != INNER_BC) && (bound != OUTER_BC)) {
            KADATH_THROW("Unknown boundary in Domain_critic_inner::nbr_points_boundary");
        }
    ...
    void Domain_critic_inner::do_which_points_boundary(int bound, const Base_spectral&, Index** which_coef,
                                                       int start) const
    {
        ...
        switch (bound) {
            ...
            case OUTER_BC:
                ...
                break;
            default:
                KADATH_THROW("Unknown boundary in Domain_critic_inner::do_which_points_boundary");
        }
