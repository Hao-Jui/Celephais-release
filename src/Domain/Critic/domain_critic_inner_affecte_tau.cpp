...
namespace Kadath
{
    void Domain_critic_inner::affecte_tau_val_domain(Val_domain& so, const Array<double>& values, int& conte) const
    {
        ...
        do {
            ...
            switch (base_r) {
                ...
                case LEG_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Uknown base in Domain_critic_inner::affecte_tau_val_domain");
            }
    ...
    void Domain_critic_inner::affecte_tau(Tensor& tt, int dom, const Array<double>& cf, int& pos_cf) const
    {
