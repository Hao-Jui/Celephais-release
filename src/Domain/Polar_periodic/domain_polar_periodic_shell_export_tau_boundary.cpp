...
namespace Kadath
{
    void Domain_polar_periodic_shell::export_tau_val_domain_boundary(const Val_domain& so, int bound,
        ...
        if (so.check_if_zero())
            ...
            switch (basetime) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown time basis in Domain_polar_periodic_shell_export_tau_val_domain_boundary");
            }
            ...
            for (int k = mink; k < maxk; k++) {
                ...
                switch (baset) {
                    ...
                    default:
                        KADATH_THROW("Unknown theta basis in Domain_polar_periodic_shell_export_tau_val_domain");
                }
    ...
    void Domain_polar_periodic_shell::export_tau_boundary(const Tensor& tt, int dom, int bound, Array<double>& res,
                                                          ...
                                                          Array<int>** p_cmp) const
    {
        ...
        if ((bound != OUTER_BC) && (bound != INNER_BC)) {
            KADATH_THROW("Unknown boundary in Domain_polar_periodic_shell::export_tau_boundary");
        }
        ...
        switch (val) {
            ...
            default:
                ...
                oss << "Valence " << val << " not implemented in Domain_polar_periodic_shell::export_tau_boundary"
                     << endl;
