...
namespace Kadath
{
    int Domain_polar_periodic_nucleus::nbr_conditions_val_domain_boundary(const Val_domain& so) const
    {
            ...
            for (int j = 0; j < nbr_coefs(1); j++) {
                ...
                switch (basetime) {
                    ...
                    case SIN:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknow time basis in Domain_polar_polar_nucleus::nbr_conditions_val_domain_boundary");
                }
                ...
                switch (baset) {
                    ...
                    case SIN_ODD:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknow theta basis in Domain_polar_periodic_nucleus::nbr_conditions_val_boundary");
                }
    ...
    Array<int> Domain_polar_periodic_nucleus::nbr_conditions_boundary(const Tensor& tt, int dom, int bound, int n_cmp,
                                                                      Array<int>** p_cmp) const
    {

        // Check boundary
        if (bound != OUTER_BC) {
            KADATH_THROW("Unknown boundary in Domain_polar_periodic_nucleus::nbr_conditions_boundary");
        }
