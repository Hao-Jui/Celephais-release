...
namespace Kadath
{
    ...
    Term_eq Domain_polar_periodic_shell::partial_spher(const Term_eq& so) const
    {
        ...
        do {
            ...
            switch (pos_auxi(0)) {
                ...
                case 2:
                    // 1/r sint d/dphi
                    auxi_val.set(pos_auxi).set_domain(dom) = 0.;
                    break;
                default:
                    KADATH_THROW("Bad indice in Domain_polar_periodic_shell::derive_partial_spher");
            }
        } while (pos_auxi.inc());
        ...
        if (so.der_t == nullptr) {
            ...
            do {
                ...
                switch (pos_auxi_der(0)) {
                    ...
                    case 2:
                        // 1/r sint d/dphi
                        auxi_der.set(pos_auxi_der).set_domain(dom) = 0.;
                        break;
                    default:
                        KADATH_THROW("Bad indice in Domain_polar_periodic_shell::derive_partial_spher");
                }
    ...
    Term_eq Domain_polar_periodic_shell::derive_flat_spher(int type_der, char ind_der, const Term_eq& so,
                                                           const Metric* manipulator) const
    {
        ...
        Tensor auxi_val(so.val_t->get_space(), val_res, type_ind, basis, 3);
        ...
        do {
            ...
            switch (pos_auxi_bis(0)) {
                ...
                case 2:
                    // 1/r sint d/dphi
                    auxi_val.set(pos_auxi_bis).set_domain(num_dom) = 0;
                    break;
                default:
                    KADATH_THROW("Bad indice in Domain_polar_periodic_shell::derive_flat_spher");
            }
        ...
        if (so.der_t == nullptr) {
            ...
            do {
                ...
                switch (pos_auxi_der_bis(0)) {
                    ...
                    case 2:
                        // 1/r sint d/dphi
                        auxi_der.set(pos_auxi_der_bis).set_domain(num_dom) = 0.;
                        break;
                    default:
                        KADATH_THROW("Bad indice in Domain_polar_periodic_shell::derive_flat_spher");
                }
            ...
            if (!need_sum)
                ...
                // Might be in the case where der_t has been destroyed
