...
namespace Kadath
{
    void Domain_polar_periodic_shell::affecte_tau_val_domain(Val_domain& so, const Array<double>& values,
                                                             int& conte) const
    {
        ...
        *so.cf = 0.;
        ...
        switch (basetime) {
            ...
            case SIN:
                ...
                break;
            default:
                KADATH_THROW("Unknown basis in Domain_polar_periodic_shell_affecte_tau_val_domain");
        }
        // Loop on time
        for (int k = mink; k < maxk; k++) {
            ...
            switch (baset) {
                ...
                default:
                    KADATH_THROW("Unknown theta basis in Domain_polar_periodic_shell_affecte_tau_val_domain");
            }
    ...
    void Domain_polar_periodic_shell::affecte_tau(Tensor& tt, int dom, const Array<double>& cf, int& pos_cf) const
    {
        ...
        switch (val) {
            ...
            default:
                ...
                oss << "Valence " << val << " not implemented in Domain_polar_periodic_shell::affecte_tau" << endl;
