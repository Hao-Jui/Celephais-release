        ...
        do {
            ...
            switch (basetime) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow time basis in Domain_polar_polar_nucleus::nbr_unknowns_val_domain");
            }
            ...
            switch (baset) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow theta basis in Domain_polar_periodic_nucleus::nbr_unknowns_val_domain");
            }
            ...
            if (indic) {
                ...
                switch (baser) {
                    ...
                    case LEG_ODD:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknown base in Domain_polar_periodic_nucleus::nbr_unknowns_val_domain");
                }
            }
