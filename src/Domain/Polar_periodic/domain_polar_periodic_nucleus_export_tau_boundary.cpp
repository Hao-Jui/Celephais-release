...
namespace Kadath
{
    void Domain_polar_periodic_nucleus::export_tau_val_domain_boundary(const Val_domain& so, int bound,
        ...
        if (so.check_if_zero())
            ...
            switch (basetime) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown time basis in Domain_polar_periodic_nucleus_export_tau_val_domain_boundary");
            }
    ...
    void Domain_polar_periodic_nucleus::export_tau_boundary(const Tensor& tt, int dom, int bound, Array<double>& res,
                                                            ...
                                                            Array<int>** p_cmp) const
    {
        ...
        // Check boundary
        if (bound != OUTER_BC) {
            KADATH_THROW("Unknown boundary in Domain_polar_periodic_nucleus::export_tau_boundary");
        }
        ...
        switch (val) {
            ...
            default:
                ...
                oss << "Valence " << val << " not implemented in Domain_polar_periodic_nucleus::export_tau_boundary"
                     << endl;
