...
namespace Kadath
{
        ...
        do {
            ...
            switch (basetime) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow time basis in Domain_polar_polar_shell::nbr_conditions_val_domain");
            }
            ...
            switch (baset) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow theta basis in Domain_polar_periodic_shell::nbr_conditions_val_domain");
            }
            ...
            switch (order) {
                ...
                case 0:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown case in Domain_polar_periodic_shell_nbr_conditions");
            }
    ...
    Array<int> Domain_polar_periodic_shell::nbr_conditions(const Tensor& tt, int dom, int order, int n_cmp,
