    ...
    void Domain_spheric_time_shell::find_other_dom(int dom, int bound, int& other_dom, int& other_bound) const
    {
        ...
        switch (bound) {
            ...
            case INNER_BC:
                ...
                break;
            default:
                KADATH_THROW("Unknown boundary case in Domain_spheric_time_shell::find_other_dom");
        }
    }
        ...
        if (so.check_if_zero())
            ...
            switch (bound) {
                ...
                case TIME_INIT:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown boundary type in Domain_spheric_time_shell::val_boundary");
            }
