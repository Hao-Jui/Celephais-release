...
namespace Kadath
{
    int Domain_spheric_time_nucleus::nbr_conditions_val_domain_array(const Val_domain& so,
    ...
    Array<int> Domain_spheric_time_nucleus::nbr_conditions_array(const Tensor& tt, int dom, const Array<int>& order,
