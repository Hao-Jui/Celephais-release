...
namespace Kadath
{
    void Domain_spheric_time_compact::affecte_tau_val_domain(Val_domain& so, const Array<double>& values,
                                                             int& conte) const
    {
    ...
    void Domain_spheric_time_compact::affecte_tau(Tensor& tt, int dom, const Array<double>& cf, int& pos_cf) const
    {
