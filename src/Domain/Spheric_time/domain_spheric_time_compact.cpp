...
namespace Kadath
{
    ...
    Domain_spheric_time_compact::Domain_spheric_time_compact(int numdom, int ttype, double tmmin, double tmmax,
                                                             double r, const Dim_array& nbr)
    ...
    // Constructor by copy
    Domain_spheric_time_compact::Domain_spheric_time_compact(const Domain_spheric_time_compact& so)
        : Domain(so), alpha(so.alpha), tmin(so.tmin), tmax(so.tmax)
    {
    }

    Domain_spheric_time_compact::Domain_spheric_time_compact(int num, BinarySource& source) : Domain(num, source)
    {
    ...
    void Domain_spheric_time_compact::save(BinarySink& sink) const
    {
    ...
    void Domain_spheric_time_compact::do_coloc()
    {
        ...
        switch (type_base) {
            ...
            case LEG_TYPE:
                ...
                break;
            default:
                KADATH_THROW("Unknown type of basis in Domain_spheric_time_compact::do_coloc");
        }
    }
