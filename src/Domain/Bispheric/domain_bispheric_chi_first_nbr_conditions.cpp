...
namespace Kadath
{
    int Domain_bispheric_chi_first::nbr_conditions_val_domain(const Val_domain& so, int order) const
    {
        ...
        switch (order) {
            ...
            case 2:
                ...
                break;
            default:
                KADATH_THROW("Unknown order in Domain_bispheric_chi_first::nbr_conditons_val_domain");
        }
            ...
            for (int j = 0; j < nbr_coefs(1); j++) {
                ...
                switch (basep) {
                    ...
                    case SIN:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknwon phi basis in Domain_bispheric_chi_first:nbr_conditions_val_domain");
                }
    ...
    Array<int> Domain_bispheric_chi_first::nbr_conditions(const Tensor& tt, int dom, int order, int n_cmp,
                                                          Array<int>** p_cmp) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_chi_first::nbr_conditions");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_chi_first::nbr_conditions");
                }
            } break;
            default:
    ...
    bool Domain_bispheric_chi_first::describe_volume_residual_rows(
