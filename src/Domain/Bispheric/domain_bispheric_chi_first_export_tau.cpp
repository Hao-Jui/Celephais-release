...
namespace Kadath
{
    void Domain_bispheric_chi_first::export_tau_val_domain(const Val_domain& so, int order, Array<double>& sec,
                                    ...
                                    if ((k == 0) || (k % 2 == 1)) {
                                        ...
                                        switch (type_base) {
                                            ...
                                            case LEG_TYPE:
                                                ...
                                                break;
                                            default:
                                                KADATH_THROW("Unknown type of basis in Domain_bispheric_chi_first::export_tau_val_domain");
                                        }
                                        pos_galerkin = pos_cf;
    ...
    void Domain_bispheric_chi_first::export_tau(const Tensor& tt, int dom, int order, Array<double>& res, int& pos_res,
                                                const Array<int>& ncond, int n_cmp, Array<int>** p_cmp) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_chi_first::export_tau");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_chi_first::export_tau");
                }
            } break;
            default:
