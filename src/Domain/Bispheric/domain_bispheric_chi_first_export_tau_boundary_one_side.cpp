...
namespace Kadath
{
    void Domain_bispheric_chi_first::export_tau_val_domain_boundary_one_side(const Val_domain& so, int bound,
                        ...
                        switch (basep) {
                                    ...
                                    if ((k == 0) || (k % 2 == 1)) {
                                        ...
                                        switch (type_base) {
                                            ...
                                            case LEG_TYPE:
                                                ...
                                                break;
                                            default:
                                                KADATH_THROW("Unknown type of basis in Domain_bispheric_chi_first::export_tau_val_domain_boundary_one_side");
                                        }
                                        pos_galerkin = pos;
                            ...
                            default:
                                cerr << "Unknown base in "
                                        "Domain_bispheric_chi_first::export_tau_val_domain_boundary_one_side"
                                     << endl;
                                break;
                        }
                    }
    ...
    void Domain_bispheric_chi_first::export_tau_boundary_one_side(const Tensor& tt, int dom, int bound,
                                                                  ...
                                                                  Array<int>** p_cmp) const
    {
        ...
        if ((bound != INNER_BC) && (bound != CHI_ONE_BC) && (bound != OUTER_BC)) {
            KADATH_THROW("Unknown boundary in Domain_bispheric_chi_first::export_tau_boundary_one_side");
        }
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_chi_first::export_tau_boundary_one_side");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_chi_first::export_tau_boundary_one_side");
                }
            } break;
            default:
                cerr << "Valence " << val
                     << " not implemented in Domain_bispheric_chi_first::export_tau_boundary_one_side" << endl;
                break;
        }
    }
} // namespace Kadath
