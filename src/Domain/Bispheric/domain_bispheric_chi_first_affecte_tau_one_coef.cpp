...
namespace Kadath
{
    namespace
    {
        bool append_bispheric_chi_first_tau_seed_component(
        ...
        do {
            ...
            switch (basep) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown phi basis in Domain_bispheric_chi_first::affecte_tau_val_domain");
            }
                    ...
                    if ((pos_cf(2) % 2 == 0) && (pos_cf(2) != 0)) {
                        ...
                        switch (basechi) {
                            ...
                            case LEG_EVEN:
                                ...
                                break;
                            default:
                                KADATH_THROW("Unknown base in Domain_bispheric_chi_first::affecte_one_coef");
                        }
    ...
    void Domain_bispheric_chi_first::affecte_tau_one_coef(Tensor& tt, int dom, int cc, int& pos_cf) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_chi_first::affecte_tau_one_coef");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_chi_first::affecte_tau_one_coef");
                }
            } break;
            default:
    ...
    bool Domain_bispheric_chi_first::describe_tau_seed_block(
        ...
        std::vector<TauSeedDescriptor>& descriptors) const
    {
        ...
        for (int component = 0; component < tt.get_n_comp(); ++component) {
            ...
            if (!append_bispheric_chi_first_tau_seed_component(
