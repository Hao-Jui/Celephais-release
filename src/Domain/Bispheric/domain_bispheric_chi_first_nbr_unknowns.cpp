...
namespace Kadath
{
    int Domain_bispheric_chi_first::nbr_unknowns_val_domain(const Val_domain& so) const
    {
        ...
        do {
            ...
            switch (basep) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown phi basis in Domain_bispheric_chi_first::nbr_unknowns_val_domain");
            }
            if (indic)
                res++;
        } while (pos.inc());
    ...
    int Domain_bispheric_chi_first::nbr_unknowns(const Tensor& tt, int dom) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_chi_first::nbr_unknowns");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_chi_first::nbr_unknowns");
                }
            } break;
            default:
                cerr << "Valence " << val << " not implemented in Domain_bispheric_chi_first::nbr_unknowns" << endl;
                break;
        }
        return res;
    }
