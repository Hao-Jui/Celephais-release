...
namespace Kadath
{
    void Domain_bispheric_eta_first::affecte_tau_val_domain(Val_domain& so, const Array<double>& values,
                                                            int& conte) const
    {
        ...
        do {
            ...
            switch (basep) {
                ...
                case SIN:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown phi basis in Domain_bispheric_eta_first::affecte_tau_val_domain");
            }
                    ...
                    for (int i = 1; i < nbr_coefs(0); i++) {
                        ...
                        switch (basechi) {
                            ...
                            case LEG_EVEN:
                                ...
                                break;
                            default:
                                KADATH_THROW("Unknown base in Domain_bispheric_eta_first::affecte_one_coef");
                        }
                    }
                    pos.set(0) = 0;
                    so.cf->set(pos) = -summ;
    ...
    void Domain_bispheric_eta_first::affecte_tau(Tensor& tt, int dom, const Array<double>& cf, int& pos_cf) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_eta_first::affecte_tau");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_eta_first::affecte_tau");
                }
            } break;
            default:
