...
namespace Kadath
{
    void Domain_bispheric_eta_first::export_tau_val_domain(const Val_domain& so, int order, Array<double>& sec,
        ...
        if (so.check_if_zero())
            ...
            switch (order) {
                ...
                case 2:
                    ...
                    break;
                default:
                    cerr << "Unknown order in Domain_bispheric_eta_first::export_tau_val_domain" << endl;
                    break;
            }
                                    ...
                                    if ((k == 0) || (k % 2 == 1)) {
                                        ...
                                        switch (type_base) {
                                            ...
                                            case LEG_TYPE:
                                                ...
                                                break;
                                            default:
                                                KADATH_THROW("Unknown type of basis in Domain_bispheric_eta_first::export_tau_val_domain");
                                        }
                                        pos_galerkin = pos_cf;
                                ...
                                if ((k != 0) && (k != nbr_coefs(2) - 1))
                                    ...
                                    if ((k % 2 != 1) || (i != nbr_coefs(0) - 1 - forgot_chi)) {
                                        if (k % 2 == 1) {
                                            ...
                                            pos_galerkin.set(0) = 0;
                                            sec.set(pos_sec) =
                                                (*so.cf)(pos_cf) + factor_galerkin * (*so.cf)(pos_galerkin);
                                            pos_sec++;
                                        }
                                    }
                                break;
                            default:
                                cerr << "Unknown base in Domain_bispheric_eta_first::export_tau_val_domain" << endl;
                                break;
                        }
                    }
                }
    ...
    void Domain_bispheric_eta_first::export_tau(const Tensor& tt, int dom, int order, Array<double>& res, int& pos_res,
                                                const Array<int>& ncond, int n_cmp, Array<int>** p_cmp) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_eta_first::export_tau");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_eta_first::export_tau");
                }
            } break;
            default:
                cerr << "Valence " << val << " not implemented in Domain_bispheric_eta_first::export_tau" << endl;
                break;
        }
    }
} // namespace Kadath
