...
namespace Kadath
{
    void Domain_bispheric_chi_first::export_tau_val_domain_boundary(const Val_domain& so, int bound, Array<double>& sec,
                    ...
                    for (int j = 0; j < nbr_coefs(1); j++) {
                        ...
                        switch (basep) {
                                    ...
                                    if ((k == 0) || (k % 2 == 1)) {
                                        ...
                                        switch (type_base) {
                                            ...
                                            case LEG_TYPE:
                                                ...
                                                break;
                                            default:
                                                KADATH_THROW("Unknown type of basis in Domain_bispheric_chi_first::export_tau_val_domain_boundary");
                                        }
                                        pos_galerkin = pos;
                            ...
                            case SIN:
                                ...
                                break;
                            default:
                                cerr << "Unknown base in Domain_bispheric_chi_first::export_tau_val_domain_boundary"
                                     << endl;
                                break;
                        }
                    }
    ...
    void Domain_bispheric_chi_first::export_tau_boundary(const Tensor& tt, int dom, int bound, Array<double>& res,
                                                         ...
                                                         Array<int>** p_cmp) const
    {
        ...
        if ((bound != INNER_BC) && (bound != CHI_ONE_BC) && (bound != OUTER_BC)) {
            KADATH_THROW("Unknown boundary in Domain_bispheric_chi_first::export_tau_boundary");
        }
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_chi_first::export_tau_boundary");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_chi_first::export_tau_boundary");
                }
            } break;
            default:
                cerr << "Valence " << val << " not implemented in Domain_bispheric_chi_first::export_tau_boundary"
                     << endl;
                break;
        }
    }
