...
namespace Kadath
{
    void Domain_bispheric_eta_first::export_tau_val_domain_boundary_one_side(const Val_domain& so, int bound,
                    ...
                    for (int i = 0; i < nbr_coefs(0) - 1; i++) {
                        ...
                        switch (basep) {
                                    ...
                                    if ((k == 0) || (k % 2 == 1)) {
                                        ...
                                        switch (type_base) {
                                            ...
                                            case LEG_TYPE:
                                                ...
                                                break;
                                            default:
                                                KADATH_THROW("Unknown type of basis in Domain_bispheric_eta_first::export_tau_val_domain_boundary_one_side");
                                        }
                                        pos_galerkin = pos;
                            ...
                            case SIN:
                                ...
                                break;
                            default:
                                cerr << "Unknown base in "
                                        "Domain_bispheric_eta_first::export_tau_val_domain_boundary_one_side"
                                     << endl;
                                break;
                        }
                    }
    ...
    void Domain_bispheric_eta_first::export_tau_boundary_one_side(const Tensor& tt, int dom, int bound,
                                                                  Array<double>& res, int& pos_res,
                                                                  const Array<int>& ncond, int n_cmp,
                                                                  Array<int>** p_cmp) const
    {

        // Check boundary
        if ((bound != ETA_MINUS_BC) && (bound != ETA_PLUS_BC) && (bound != OUTER_BC)) {
            KADATH_THROW("Unknown boundary in Domain_bispheric_eta_first::export_tau_boundary_one_side");
        }
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_bispheric_eta_first::export_tau_boundary_one_side");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_bispheric_eta_first::export_tau_boundary_one_side");
                }
            } break;
            default:
                cerr << "Valence " << val
                     << " not implemented in Domain_bispheric_eta_first::export_tau_boundary_one_side" << endl;
                break;
        }
    }
} // namespace Kadath
