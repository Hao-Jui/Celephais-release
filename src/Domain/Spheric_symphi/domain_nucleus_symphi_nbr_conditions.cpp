...
namespace Kadath
{
        ...
        do {
            ...
            switch (order) {
                ...
                case 0:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown case in Domain_nucleus_symphi_nbr_conditions");
            }
    ...
    Array<int> Domain_nucleus_symphi::nbr_conditions(const Tensor& tt, int dom, int order, int n_cmp,
                                                     Array<int>** p_cmp) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_nucleus_symphi::nbr_conditions");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_nucleus_symphi::nbr_conditions");
                }
            } break;
            default:
