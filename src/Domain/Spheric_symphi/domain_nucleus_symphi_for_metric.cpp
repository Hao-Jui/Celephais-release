...
namespace Kadath
{
    Term_eq Domain_nucleus_symphi::derive_flat_spher(int type_der, char ind_der, const Term_eq& so,
        ...
        do {
            ...
            switch (pos_auxi_bis(0)) {
                ...
                case 2:
                    ...
                    break;
                default:
                    KADATH_THROW("Bad indice in Domain_nucleus_symphi::derive_flat_spher");
            }
    ...
    Term_eq Domain_nucleus_symphi::derive_flat_cart(int type_der, char ind_der, const Term_eq& so,
                                                    const Metric* manipulator) const
    {
