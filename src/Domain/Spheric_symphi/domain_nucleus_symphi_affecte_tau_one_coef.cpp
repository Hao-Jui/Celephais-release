        ...
        *so.cf = 0.;
        ...
        switch (basep) {
            ...
            case SIN_ODD:
                ...
                break;
            default:
                KADATH_THROW("Unknow phi basis in Domain_nucleus_symphi::affecte_tau_one_coef_val_domain");
        }
            ...
            for (int j = 0; j < nbr_coefs(1); j++) {
                ...
                for (int i = 0; i < nbr_coefs(0); i++) {
                    ...
                    switch (baset) {
                                ...
                                if (i != 0) {
                                    if (conte == cc) {
                                        ...
                                        switch (baser) {
                                            ...
                                            default:
                                                KADATH_THROW("Strange base in Domain_nucleus_symphi::affecte_one_coef_val_domain");
                                        }
                                        so.cf->set(pos_cf) = 1;
                        ...
                        default:
                            KADATH_THROW("Unknow theta basis in Domain_nucleus_symphi::affecte_coef_val_domain");
                    }
                }
            }
        }
    ...
    void Domain_nucleus_symphi::affecte_tau_one_coef(Tensor& tt, int dom, int cc, int& pos_cf) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_nucleus_symphi::affecte_tau_one_coef");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_nucleus_symphi::affecte_tau_one_coef");
                }
            } break;
            default:
