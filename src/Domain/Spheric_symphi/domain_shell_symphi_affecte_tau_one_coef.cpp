...
namespace Kadath
{
    void Domain_shell_symphi::affecte_tau_one_coef_val_domain(Val_domain& so, int cc, int& conte) const
    {
        ...
        *so.cf = 0.;
        ...
        switch (basep) {
            ...
            case SIN_ODD:
                ...
                break;
            default:
                KADATH_THROW("Unknow phi basis in Domain_shell_symphi::affecte_tau_one_coef_val_domain");
        }
    ...
    void Domain_shell_symphi::affecte_tau_one_coef(Tensor& tt, int dom, int cc, int& pos_cf) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_shell_symphi::affecte_tau_one_coef");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_shell_symphi::affecte_tau_one_coef");
                }
            } break;
            default:
