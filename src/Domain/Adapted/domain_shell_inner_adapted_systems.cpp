...
namespace Kadath
{
    void Domain_shell_inner_adapted::find_other_dom(int dom, int bound, int& other_dom, int& other_bound) const
    {
        ...
        switch (bound) {
            ...
            case OUTER_BC:
                ...
                break;
            default:
                KADATH_THROW("Unknown boundary case in Domain_shell_inner_adapted::find_other_dom");
        }
    }
        ...
        if (so.check_if_zero())
            ...
            switch (bound) {
                ...
                case OUTER_BC:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown boundary type in Domain_shell_inner_adapted::val_boundary");
            }
            return res;
        }
    }
    ...
    int Domain_shell_inner_adapted::nbr_points_boundary(int bound, const Base_spectral& bb) const
    {
        ...
        if ((bound != INNER_BC) && (bound != OUTER_BC)) {
            KADATH_THROW("Unknown boundary in Domain_shell_inner_adapted::nbr_points_boundary");
        }
    ...
    void Domain_shell_inner_adapted::do_which_points_boundary(int bound, const Base_spectral& bb, Index** which_coef,
                                                              int start) const
    {
        ...
        switch (bound) {
            ...
            case OUTER_BC:
                ...
                break;
            default:
                KADATH_THROW("Unknown boundary in Domain_shell_inner_adapted::do_which_points_inside");
        }
