...
namespace Kadath
{
    void Domain_shell_inner_adapted::export_tau_val_domain(const Val_domain& so, int mlim, int order,
                        ...
                        for (int i = 0; i < nbr_coefs(0) - order; i++) {
                            ...
                            switch (baset) {
                                ...
                                case SIN_ODD:
                                    ...
                                    break;
                                default:
                                    KADATH_THROW("Unknow theta basis in Domain_shell_inner_adapted::export_tau_val_domain");
                            }
                        }
                    }
                }
    ...
    void Domain_shell_inner_adapted::export_tau(const Tensor& tt, int dom, int order, Array<double>& res, int& pos_res,
                                                const Array<int>& ncond, int n_cmp, Array<int>** p_cmp) const
    {
        ...
        switch (val) {
            ...
            case 1: {
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of vector Domain_shell_inner_adapted::export_tau");
                }
            } break;
            case 2: {
                bool found = false;
                ...
                if (!found) {
                    KADATH_THROW("Unknown type of 2-tensor Domain_shell_inner_adapted::export_tau");
                }
            } break;
            default:
