...
namespace Kadath
{
    ...
    Domain_spheric_periodic_nucleus::Domain_spheric_periodic_nucleus(int num, int ttype, int typet, double r,
    ...
    // Constructor by copy
    Domain_spheric_periodic_nucleus::Domain_spheric_periodic_nucleus(const Domain_spheric_periodic_nucleus& so)
        : Domain(so), alpha(so.alpha), ome(so.ome), type_time(so.type_time), maxt(so.maxt)
    {
    }

    Domain_spheric_periodic_nucleus::Domain_spheric_periodic_nucleus(int num, BinarySource& source)
        : Domain(num, source)
    {
    ...
    void Domain_spheric_periodic_nucleus::save(BinarySink& sink) const
    {
    ...
    Val_domain Domain_spheric_periodic_nucleus::der_normal(const Val_domain& so, int bound) const
    {
        ...
        switch (bound) {
            case OUTER_BC:
                ...
                break;
            default:
                KADATH_THROW("Unknown boundary case in Domain_spheric_periodic_nucleus::der_normal");
        }
        return res;
    }
    ...
    void Domain_spheric_periodic_nucleus::do_coloc()
    {
        ...
        switch (type_base) {
            ...
            case LEG_TYPE:
                ...
                break;
            default:
                KADATH_THROW("Unknown type of basis in Domain_spheric_periodic_nucleus::do_coloc");
        }
    }
