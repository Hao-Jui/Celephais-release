...
namespace Kadath
{
        ...
        do {
            ...
            switch (baset) {
                ...
                case COS:
                    break;
                default:
                    KADATH_THROW("Unknow time basis in Domain_spheric_periodic_nucleus::nbr_conditions_val_domain");
            }
    ...
    Array<int> Domain_spheric_periodic_nucleus::nbr_conditions(const Tensor& tt, int dom, int order, int n_cmp,
                                                               Array<int>**) const
    {
        ...
        switch (val) {
            case 0:
                ...
                break;
            default:
                cerr << "Valence " << val << " not implemented in Domain_spheric_periodic_nucleus::nbr_conditions"
                     << endl;
                break;
        }
        return res;
