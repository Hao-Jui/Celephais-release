...
namespace Kadath
{
    void Domain_polar_nucleus::affecte_tau_val_domain(Val_domain& so, int mquant, int llim, const Array<double>& values,
                                                      int& conte) const
    {
            ...
            for (int i = 0; i < nbr_coefs(0); i++) {
                ...
                switch (baset) {
                    ...
                    case SIN_ODD:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknow theta basis in Domain_polar_nucleus::affecte_tau_val_domain");
                }
            }
        }
    }

    void Domain_polar_nucleus::affecte_tau(Tensor& tt, int dom, const Array<double>& cf, int& pos_cf) const
    {
