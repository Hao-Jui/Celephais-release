...
namespace Kadath
{
    void Domain_polar_compact::export_tau_val_domain(const Val_domain& so, int mquant, int order, Array<double>& sec,
                ...
                for (int i = 0; i < nbr_coefs(0) - imax; i++) {
                    ...
                    switch (baset) {
                        ...
                        case SIN_ODD:
                            ...
                            break;
                        default:
                            KADATH_THROW("Unknow theta basis in Domain_polar_compact::export_tau_val_domain");
                    }
                }
    ...
    void Domain_polar_compact::export_tau(const Tensor& tt, int dom, int order, Array<double>& res, int& pos_res,
