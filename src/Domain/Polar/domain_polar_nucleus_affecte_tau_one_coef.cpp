...
namespace Kadath
{
    void Domain_polar_nucleus::affecte_tau_one_coef_val_domain(Val_domain& so, int mquant, int llim, int cc,
                                                               int& conte) const
    {
            ...
            for (int i = 0; i < nbr_coefs(0); i++) {
                ...
                switch (baset) {
                            ...
                            if (i != 0) {
                                if (conte == cc) {
                                    ...
                                    switch (baser) {
                                        ...
                                        default:
                                            KADATH_THROW("Strange base in Domain_polar_nucleus::affecte_one_coef_val_domain");
                                    }
                                    so.cf->set(pos_cf) = 1;
                    ...
                    case SIN_ODD:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknow theta basis in Domain_polar_nucleus::affecte_coef_val_domain");
                }
            }
        }
        ...
        switch (val) {
            case 0:
                if (!tt.is_m_quant_affected())
                    ...
                    affecte_tau_one_coef_val_domain(tt.set().set_domain(dom), tt.get_parameters()->get_m_quant(), 0, cc,
                                                    pos_cf);
                break;
