...
namespace Kadath
{
    void Domain_polar_shell::affecte_tau_one_coef_val_domain(Val_domain& so, int mquant, int cc, int& conte) const
    {
        ...
        for (int j = 0; j < nbr_coefs(1); j++) {
            ...
            switch (baset) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow theta basis in Domain_polar_shell::affecte_one_coef_val_domain");
            }
    ...
    void Domain_polar_shell::affecte_tau_one_coef(Tensor& tt, int dom, int cc, int& pos_cf) const
    {
