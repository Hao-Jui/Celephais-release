        ...
        do {
            ...
            switch (baset) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow theta basis in Domain_polar_nucleus::nbr_unknowns_val_domain");
            }
            ...
            if (indic) {
                ...
                switch (baser) {
                    case CHEB_EVEN:
                        switch (baset) {
                            ...
                            case SIN_EVEN:
                                ...
                                break;
                            default:
                                KADATH_THROW("Strange base in Domain_polar_nucleus::nbr_conditions_val_domain");
                        }
                        max = nbr_coefs(0);
                        break;
                    case LEG_EVEN:
                    ...
                    case LEG_ODD:
                        ...
                        break;
                    default:
                        KADATH_THROW("Unknown base in Domain_polar_nucleus::nbr_conditions_val_domain");
                }
            }
            ...
            switch (order) {
                ...
                case 0:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknown case in Domain_polar_nucleus_nbr_conditions");
            }
