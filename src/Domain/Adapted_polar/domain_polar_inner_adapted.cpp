...
namespace Kadath
{
    ...
    Domain_polar_shell_inner_adapted::Domain_polar_shell_inner_adapted(const Space& sss, int num, int ttype, double rin,
                                                                       double rout, const Point& cr,
                                                                       const Dim_array& nbr)
    ...
    Domain_polar_shell_inner_adapted::Domain_polar_shell_inner_adapted(const Space& sss, int num, int ttype,
                                                                       const Val_domain& rin, double rout,
    ...
    // Constructor by copy
    Domain_polar_shell_inner_adapted::Domain_polar_shell_inner_adapted(const Domain_polar_shell_inner_adapted& so)
    ...
    // Constructor by copy
    Domain_polar_shell_inner_adapted::Domain_polar_shell_inner_adapted(const Space& sp,
                                                                       const Domain_polar_shell_inner_adapted& so)
        : Domain(so, true), sp(sp), outer_radius(so.outer_radius), center(so.center)
    {
    ...
    Domain_polar_shell_inner_adapted::Domain_polar_shell_inner_adapted(const Space& sss, int num,
                                                                       BinarySource& source)
    ...
    void Domain_polar_shell_inner_adapted::do_radius() const
    {
        ...
        do
            radius->set(index) = (outer_radius - (*inner_radius)(index)) / 2. * ((*coloc[0])(index(0))) +
    ...
    void Domain_polar_shell_inner_adapted::xx_to_vars_from_adapted(Val_domain& new_inner_radius,
    ...
    void Domain_polar_shell_inner_adapted::update_variable(const Val_domain& cor_inner_radius, const Scalar& old,
                                                           Scalar& res) const
    {
            ...
            if ((*inner_radius_term_eq->der_t)()(num_dom).check_if_zero()) {
                ...
                do {
                    der_res.set_domain(num_dom).set(index) =
                        -((*inner_radius_term_eq->der_t)()(num_dom))(index) / 2. * ((*coloc[0])(index(0))) +
    ...
    void Domain_polar_shell_inner_adapted::save(BinarySink& sink) const
    {
    ...
    {
        KADATH_THROW("Domain_polar_shell_inner_adapted::der_normal not implemeted");
    }
    ...
    void Domain_polar_shell_inner_adapted::do_coloc()
    {
        ...
        switch (type_base) {
            ...
            case LEG_TYPE:
                ...
                break;
            default:
                KADATH_THROW("Unknown type of basis in Domain_polar_shell_inner_adapted::do_coloc");
        }
    }
    ...
    void Domain_polar_shell_inner_adapted::update_constante(const Val_domain& cor_inner_radius, const Scalar& old,
                                                            Scalar& res) const
    {
    ...
    double Domain_polar_shell_inner_adapted::integ(const Val_domain& so, int bound) const
    {
        ...
        if (baset != COS_EVEN) {
            ...
            if (bound != OUTER_BC) {
                KADATH_THROW("Domain_polar_shell_inner_adapted::integ only defined for outer boundary");
            }
