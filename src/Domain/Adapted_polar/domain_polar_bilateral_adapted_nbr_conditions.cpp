...
namespace Kadath
{
    int Domain_polar_shell_bilateral_adapted::nbr_conditions_val_domain(const Val_domain& so, int mquant,
                                                                        int order) const
    {
        ...
        do {
            ...
            switch (baset) {
                ...
                case SIN_ODD:
                    ...
                    break;
                default:
                    KADATH_THROW("Unknow theta basis in Domain_polar_shell_bilateral_adapted::nbr_conditions_val_domain");
            }
    ...
    Array<int> Domain_polar_shell_bilateral_adapted::nbr_conditions(const Tensor& tt, int dom, int order, int n_cmp,
                                                                    Array<int>**) const
    {
        ...
        switch (val) {
            case 0:
                ...
                break;
            default:
                cerr << "Valence " << val << " not implemented in Domain_polar_shell_bilateral_adapted::nbr_conditions"
                     << endl;
                break;
        }
        return res;
