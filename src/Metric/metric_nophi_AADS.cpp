...
namespace Kadath
{
    Metric_nophi_AADS::Metric_nophi_AADS(Metric_tensor& met, const Scalar& ome)
        : Metric(met.get_space()), p_met(&met), basis(met.get_basis()), fmet(met.get_space(), basis), conformal(ome),
          der_conf(conformal.der_r())
    {
        type_tensor = met.get_type();
        for (int d = 0; d < met.get_space().get_nbr_domains(); d++)
            if (basis.get_basis(d) != SPHERICAL_BASIS) {
                KADATH_THROW("Metric_nophi_AADS only defined wrt spherical tensorial coordinates");
            }
    }

    Metric_nophi_AADS::Metric_nophi_AADS(const Metric_nophi_AADS& so)
        : Metric(so), p_met(so.p_met), basis(so.basis), fmet(so.fmet), conformal(so.conformal),
          der_conf(conformal.der_r()), place_syst(so.place_syst)
    {
    }

    Metric_nophi_AADS::~Metric_nophi_AADS() {}

    int Metric_nophi_AADS::give_type(int dd) const
    {
        return basis.get_basis(dd);
    }

    void Metric_nophi_AADS::compute_cov(int dd) const
    {
        ...
        if (type_tensor == COV) {
            ...
            detval = (*syst->term[place]->val_t)(1, 1)(dd) * (*syst->term[place]->val_t)(2, 2)(dd) *
                         (*syst->term[place]->val_t)(3, 3)(dd) +
                     (*syst->term[place]->val_t)(1, 2)(dd) * (*syst->term[place]->val_t)(2, 3)(dd) *
                         (*syst->term[place]->val_t)(1, 3)(dd) +
                     (*syst->term[place]->val_t)(1, 3)(dd) * (*syst->term[place]->val_t)(1, 2)(dd) *
                         (*syst->term[place]->val_t)(2, 3)(dd) -
                     (*syst->term[place]->val_t)(1, 3)(dd) * (*syst->term[place]->val_t)(1, 3)(dd) *
                         (*syst->term[place]->val_t)(2, 2)(dd) -
                     (*syst->term[place]->val_t)(2, 3)(dd) * (*syst->term[place]->val_t)(2, 3)(dd) *
                         (*syst->term[place]->val_t)(1, 1)(dd) -
                     (*syst->term[place]->val_t)(1, 2)(dd) * (*syst->term[place]->val_t)(1, 2)(dd) *
                         (*syst->term[place]->val_t)(3, 3)(dd);
            Val_domain detder(espace.get_domain(dd));
            if (doder)
                detder = (*syst->term[place]->der_t)(1, 1)(dd) * (*syst->term[place]->val_t)(2, 2)(dd) *
                             (*syst->term[place]->val_t)(3, 3)(dd) +
                         (*syst->term[place]->der_t)(1, 2)(dd) * (*syst->term[place]->val_t)(2, 3)(dd) *
                             (*syst->term[place]->val_t)(1, 3)(dd) +
                         (*syst->term[place]->der_t)(1, 3)(dd) * (*syst->term[place]->val_t)(1, 2)(dd) *
                             (*syst->term[place]->val_t)(2, 3)(dd) -
                         ...
                         (*syst->term[place]->val_t)(1, 2)(dd) * (*syst->term[place]->der_t)(1, 2)(dd) *
                             (*syst->term[place]->val_t)(3, 3)(dd) +
                         (*syst->term[place]->val_t)(1, 1)(dd) * (*syst->term[place]->val_t)(2, 2)(dd) *
                             (*syst->term[place]->der_t)(3, 3)(dd) +
                         (*syst->term[place]->val_t)(1, 2)(dd) * (*syst->term[place]->val_t)(2, 3)(dd) *
                             (*syst->term[place]->der_t)(1, 3)(dd) +
                         (*syst->term[place]->val_t)(1, 3)(dd) * (*syst->term[place]->val_t)(1, 2)(dd) *
                             (*syst->term[place]->der_t)(2, 3)(dd) -
                         (*syst->term[place]->val_t)(1, 3)(dd) * (*syst->term[place]->val_t)(1, 3)(dd) *
                             (*syst->term[place]->der_t)(2, 2)(dd) -
                         (*syst->term[place]->val_t)(2, 3)(dd) * (*syst->term[place]->val_t)(2, 3)(dd) *
                             (*syst->term[place]->der_t)(1, 1)(dd) -
                         (*syst->term[place]->val_t)(1, 2)(dd) * (*syst->term[place]->val_t)(1, 2)(dd) *
                             (*syst->term[place]->der_t)(3, 3)(dd);
    ...
    void Metric_nophi_AADS::compute_con(int dd) const
    {
    ...
    void Metric_nophi_AADS::compute_christo(int dd) const
    {
        ...
        do {
            ...
            for (int l = 1; l <= espace.get_ndim(); l++)
                cmpval += conformal(dd) * (0.5 * (*p_met_con[dd]->val_t)(pos(2) + 1, l)(dd) *
            ...
            cmpval += (*p_met_con[dd]->val_t)(pos(2) + 1, 1)(dd) *
                      (*p_met_cov[dd]->val_t)(pos(0) + 1, pos(1) + 1)(dd)*der_conf(dd);
            if ((pos(1) == pos(2)) && (pos(0) == 0))
                cmpval -= der_conf(dd);
            if ((pos(0) == pos(2)) && (pos(1) == 0))
                cmpval -= der_conf(dd);
            ...
            if (doder) {
                ...
                cmpder = 0;
                for (int l = 1; l <= espace.get_ndim(); l++)
                    cmpder += conformal(dd) * (0.5 * (*p_met_con[dd]->der_t)(pos(2) + 1, l)(dd) *
                                                   ((*flat_der.val_t)(pos(0) + 1, pos(1) + 1, l)(dd) +
                                                    (*flat_der.val_t)(pos(1) + 1, pos(0) + 1, l)(dd) -
                                                    (*flat_der.val_t)(l, pos(0) + 1, pos(1) + 1)(dd)) +
                ...
                // Some corrections due to the conformal factor :
                cmpder +=
                    ((*p_met_con[dd]->der_t)(pos(2) + 1, 1)(dd) * (*p_met_cov[dd]->val_t)(pos(0) + 1, pos(1) + 1)(dd) +
                     (*p_met_con[dd]->val_t)(pos(2) + 1, 1)(dd) * (*p_met_cov[dd]->der_t)(pos(0) + 1, pos(1) + 1)(dd)) *
                    der_conf(dd);
    ...
    void Metric_nophi_AADS::compute_riemann(int dd) const
    {
        ...
        do {
            ...
            if (pos(2) == 0)
                cmpval -= (*p_christo[dd]->val_t)(pos(1) + 1, pos(3) + 1, pos(0) + 1)(dd)*der_conf(dd);
            if (pos(3) == 0)
                cmpval += (*p_christo[dd]->val_t)(pos(1) + 1, pos(2) + 1, pos(0) + 1)(dd)*der_conf(dd);
            ...
            res_val.set(pos).set_domain(dd) = cmpval;
            if (doder) {
                Val_domain cmpder(conformal(dd) *
                                  ((*flat_der.der_t)(pos(2) + 1, pos(1) + 1, pos(3) + 1, pos(0) + 1)(dd) -
                                   (*flat_der.der_t)(pos(3) + 1, pos(1) + 1, pos(2) + 1, pos(0) + 1)(dd)));

                if (pos(2) == 0)
                    cmpder -= (*p_christo[dd]->der_t)(pos(1) + 1, pos(3) + 1, pos(0) + 1)(dd)*der_conf(dd);
                if (pos(3) == 0)
                    cmpder += (*p_christo[dd]->der_t)(pos(1) + 1, pos(2) + 1, pos(0) + 1)(dd)*der_conf(dd);
    ...
    void Metric_nophi_AADS::compute_ricci_tensor(int dd) const
    {
        // Need christoffels
        if (p_christo[dd] == nullptr)
            compute_christo(dd);
        ...
        do {
            ...
            for (int l = 1; l <= espace.get_ndim(); l++) {
                ...
                if (l == 1)
                    cmpval -= (*p_christo[dd]->val_t)(pos(0) + 1, pos(1) + 1, l)(dd)*der_conf(dd);
                if (pos(1) == 0)
                    cmpval += (*p_christo[dd]->val_t)(pos(0) + 1, l, l)(dd)*der_conf(dd);

                for (int m = 1; m <= espace.get_ndim(); m++) {
                    cmpval +=
                        (*p_christo[dd]->val_t)(l, m, l)(dd) * (*p_christo[dd]->val_t)(pos(0) + 1, pos(1) + 1, m)(dd) -
            ...
            if (doder) {
                ...
                for (int l = 1; l <= espace.get_ndim(); l++) {
                    ...
                    if (l == 1)
                        cmpder -= (*p_christo[dd]->der_t)(pos(0) + 1, pos(1) + 1, l)(dd)*der_conf(dd);
                    if (pos(1) == 0)
                        cmpder += (*p_christo[dd]->der_t)(pos(0) + 1, l, l)(dd)*der_conf(dd);

                    for (int m = 1; m <= espace.get_ndim(); m++) {
                        cmpder += (*p_christo[dd]->der_t)(l, m, l)(dd) *
    ...
    Term_eq Metric_nophi_AADS::derive_flat(int type_der, char ind_der, const Term_eq& so) const
    {
    ...
    Term_eq Metric_nophi_AADS::derive(int type_der, char ind_der, const Term_eq& so) const
    {
    ...
    void Metric_nophi_AADS::set_system(System_of_eqs& ss, const char* name_met)
    {
