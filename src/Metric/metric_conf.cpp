...
namespace Kadath
{
    ...
    int Metric_conf::give_type(int dd) const
    {
        return basis.get_basis(dd);
    }

    void Metric_conf::compute_cov(int dd) const
    {

        int dim = espace.get_ndim();
        if (dim != 3) {
            KADATH_THROW("Function only implemented for dimension 3");
        }
        ...
        if (type_tensor == COV) {
            ...
            if (p_met_cov[dd] == nullptr)
                p_met_cov[dd] = std::make_unique<Term_eq>(*syst->term[place]);
            else
                *p_met_cov[dd] = Term_eq(*syst->term[place]);
        } else {
            // Need to work component by components...
            bool doder = (syst->term[place]->der_t == nullptr) ? false : true;
            ...
            if (doder) {
                ...
                der.set_domain(dd) = cmpder;
                res[0] = std::make_unique<Term_eq>(dd, val, der);
            } else {
            ...
            if (doder) {
                ...
                der.set_domain(dd) = cmpder;
                res[1] = std::make_unique<Term_eq>(dd, val, der);
            } else {
            ...
            if (doder) {
                ...
                der.set_domain(dd) = cmpder;
                res[2] = std::make_unique<Term_eq>(dd, val, der);
            } else {
            ...
            if (doder) {
                ...
                der.set_domain(dd) = cmpder;
                res[3] = std::make_unique<Term_eq>(dd, val, der);
            } else {
            ...
            if (doder) {
                ...
                der.set_domain(dd) = cmpder;
                res[4] = std::make_unique<Term_eq>(dd, val, der);
            } else {
            ...
            if (doder) {
                ...
                der.set_domain(dd) = cmpder;
                res[5] = std::make_unique<Term_eq>(dd, val, der);
            } else {
            ...
            if (!doder) {
                if (p_met_cov[dd] == nullptr)
                    p_met_cov[dd] = std::make_unique<Term_eq>(dd, resval);
                else
                ...
                if (p_met_cov[dd] == nullptr)
                    p_met_cov[dd] = std::make_unique<Term_eq>(dd, resval, resder);
                else
    ...
    void Metric_conf::compute_con(int dd) const
    {
        ...
        if (type_tensor == CON) {
            ...
            if (p_met_con[dd] == nullptr)
                p_met_con[dd] = std::make_unique<Term_eq>(*syst->term[place]);
            else
            ...
            if (!doder) {
                if (p_met_con[dd] == nullptr)
                    p_met_con[dd] = std::make_unique<Term_eq>(dd, resval);
                else
                ...
                if (p_met_con[dd] == nullptr)
                    p_met_con[dd] = std::make_unique<Term_eq>(dd, resval, resder);
                else
    ...
    void Metric_conf::compute_christo(int dd) const
    {
        ...
        bool doder = (flat_der.der_t == nullptr) ? false : true;
        ...
        do {
            ...
            for (int l = 1; l <= espace.get_ndim(); l++)
                cmpval += 0.5 * (*p_met_con[dd]->val_t)(pos(2) + 1, l)(dd) *
                          ((*flat_der.val_t)(pos(0) + 1, pos(1) + 1, l)(dd) +
                           (*flat_der.val_t)(pos(1) + 1, pos(0) + 1, l)(dd) -
                           (*flat_der.val_t)(l, pos(0) + 1, pos(1) + 1)(dd));
                ...
                for (int l = 1; l <= espace.get_ndim(); l++)
                    cmpder += 0.5 * (*p_met_con[dd]->der_t)(pos(2) + 1, l)(dd) *
                              ...
                              0.5 * (*p_met_con[dd]->val_t)(pos(2) + 1, l)(dd) *
                                  ((*flat_der.der_t)(pos(0) + 1, pos(1) + 1, l)(dd) +
                                   (*flat_der.der_t)(pos(1) + 1, pos(0) + 1, l)(dd) -
                                   (*flat_der.der_t)(l, pos(0) + 1, pos(1) + 1)(dd));
    ...
    void Metric_conf::compute_riemann(int dd) const
    {
    ...
    void Metric_conf::compute_ricci_tensor(int dd) const
    {
        ...
        Term_eq der_dirac(fmet.derive(COV, ' ', (*p_dirac[dd])));

        bool doder =
            ((der_cov.der_t == nullptr) || (der_con.der_t == nullptr) || (dder_con.der_t == nullptr)) ? false : true;
        ...
        do {
            ...
            for (int k = 1; k <= espace.get_ndim(); k++)
                for (int l = 1; l <= espace.get_ndim(); l++) {
                    ...
                    cmpval +=
                        0.5 * ((*p_met_con[dd]->val_t)(k, l)(dd) * (*dder_con.val_t)(k, l, pos(0) + 1, pos(1) + 1)(dd) -
                               (*der_con.val_t)(l, pos(0) + 1, k)(dd) * (*der_con.val_t)(k, pos(1) + 1, l)(dd));
                    for (int m = 1; m <= espace.get_ndim(); m++)
                        for (int n = 1; n < espace.get_ndim(); n++)
                            cmpval +=
                                0.5 *
                                (-(*p_met_cov[dd]->val_t)(k, l)(dd) * (*p_met_con[dd]->val_t)(m, n)(dd) *
                                     (*der_con.val_t)(m, pos(0) + 1, k)(dd) * (*der_con.val_t)(n, pos(1) + 1, l)(dd) +
                                 (*p_met_cov[dd]->val_t)(m, l)(dd) * (*p_met_con[dd]->val_t)(pos(0) + 1, k)(dd) *
                                     (*der_con.val_t)(k, m, n)(dd) * (*der_con.val_t)(n, pos(1) + 1, l)(dd) +
                                 (*p_met_cov[dd]->val_t)(k, n)(dd) * (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) *
                                     (*der_con.val_t)(l, m, n)(dd) * (*der_con.val_t)(m, pos(0) + 1, k)(dd) +
                                 0.5 * (*p_met_cov[dd]->val_t)(pos(0) + 1, k)(dd) *
                                     (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) * (*der_cov.val_t)(k, m, n)(dd) *
                                     (*der_con.val_t)(l, m, n)(dd));
                }

            // Dirac part
            for (int k = 1; k <= espace.get_ndim(); k++)
                cmpval += 0.5 * ((*p_dirac[dd]->val_t)(k)(dd) * (*der_con.val_t)(k, pos(0) + 1, pos(1) + 1)(dd) -
                                 (*p_met_con[dd]->val_t)(pos(0) + 1, k)(dd) * (*der_dirac.val_t)(k, pos(1) + 1)(dd) -
                                 (*p_met_con[dd]->val_t)(pos(1) + 1, k)(dd) * (*der_dirac.val_t)(k, pos(0) + 1)(dd));
            ...
            if (doder) {
                ...
                for (int k = 1; k <= espace.get_ndim(); k++)
                    for (int l = 1; l <= espace.get_ndim(); l++) {
                        ...
                        cmpder +=
                            0.5 *
                            ((*p_met_con[dd]->der_t)(k, l)(dd) * (*dder_con.val_t)(k, l, pos(0) + 1, pos(1) + 1)(dd) +
                        ...
                        for (int m = 1; m <= espace.get_ndim(); m++)
                            for (int n = 1; n < espace.get_ndim(); n++)
                                cmpval +=
                                    0.5 *
                                    (-(*p_met_cov[dd]->der_t)(k, l)(dd) * (*p_met_con[dd]->val_t)(m, n)(dd) *
                                         (*der_con.val_t)(m, pos(0) + 1, k)(dd) *
                                         (*der_con.val_t)(n, pos(1) + 1, l)(dd) -
                                     (*p_met_cov[dd]->val_t)(k, l)(dd) * (*p_met_con[dd]->der_t)(m, n)(dd) *
                                         (*der_con.val_t)(m, pos(0) + 1, k)(dd) *
                                         (*der_con.val_t)(n, pos(1) + 1, l)(dd) -
                                     (*p_met_cov[dd]->val_t)(k, l)(dd) * (*p_met_con[dd]->val_t)(m, n)(dd) *
                                         (*der_con.der_t)(m, pos(0) + 1, k)(dd) *
                                         (*der_con.val_t)(n, pos(1) + 1, l)(dd) -
                                     (*p_met_cov[dd]->val_t)(k, l)(dd) * (*p_met_con[dd]->val_t)(m, n)(dd) *
                                         (*der_con.val_t)(m, pos(0) + 1, k)(dd) *
                                         (*der_con.der_t)(n, pos(1) + 1, l)(dd) +
                                     (*p_met_cov[dd]->der_t)(m, l)(dd) * (*p_met_con[dd]->val_t)(pos(0) + 1, k)(dd) *
                                         (*der_con.val_t)(k, m, n)(dd) * (*der_con.val_t)(n, pos(1) + 1, l)(dd) +
                                     (*p_met_cov[dd]->val_t)(m, l)(dd) * (*p_met_con[dd]->der_t)(pos(0) + 1, k)(dd) *
                                         (*der_con.val_t)(k, m, n)(dd) * (*der_con.val_t)(n, pos(1) + 1, l)(dd) +
                                     (*p_met_cov[dd]->val_t)(m, l)(dd) * (*p_met_con[dd]->val_t)(pos(0) + 1, k)(dd) *
                                         (*der_con.der_t)(k, m, n)(dd) * (*der_con.val_t)(n, pos(1) + 1, l)(dd) +
                                     (*p_met_cov[dd]->val_t)(m, l)(dd) * (*p_met_con[dd]->val_t)(pos(0) + 1, k)(dd) *
                                         (*der_con.val_t)(k, m, n)(dd) * (*der_con.der_t)(n, pos(1) + 1, l)(dd) +
                                     (*p_met_cov[dd]->der_t)(k, n)(dd) * (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) *
                                         (*der_con.val_t)(l, m, n)(dd) * (*der_con.val_t)(m, pos(0) + 1, k)(dd) +
                                     (*p_met_cov[dd]->val_t)(k, n)(dd) * (*p_met_con[dd]->der_t)(pos(1) + 1, l)(dd) *
                                         (*der_con.val_t)(l, m, n)(dd) * (*der_con.val_t)(m, pos(0) + 1, k)(dd) +
                                     (*p_met_cov[dd]->val_t)(k, n)(dd) * (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) *
                                         (*der_con.der_t)(l, m, n)(dd) * (*der_con.val_t)(m, pos(0) + 1, k)(dd) +
                                     (*p_met_cov[dd]->val_t)(k, n)(dd) * (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) *
                                         (*der_con.val_t)(l, m, n)(dd) * (*der_con.der_t)(m, pos(0) + 1, k)(dd) +
                                     0.5 * (*p_met_cov[dd]->der_t)(pos(0) + 1, k)(dd) *
                                         (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) * (*der_cov.val_t)(k, m, n)(dd) *
                                         (*der_con.val_t)(l, m, n)(dd) +
                                     0.5 * (*p_met_cov[dd]->val_t)(pos(0) + 1, k)(dd) *
                                         (*p_met_con[dd]->der_t)(pos(1) + 1, l)(dd) * (*der_cov.val_t)(k, m, n)(dd) *
                                         (*der_con.val_t)(l, m, n)(dd) +
                                     0.5 * (*p_met_cov[dd]->val_t)(pos(0) + 1, k)(dd) *
                                         (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) * (*der_cov.der_t)(k, m, n)(dd) *
                                         (*der_con.val_t)(l, m, n)(dd) +
                                     0.5 * (*p_met_cov[dd]->val_t)(pos(0) + 1, k)(dd) *
                                         (*p_met_con[dd]->val_t)(pos(1) + 1, l)(dd) * (*der_cov.val_t)(k, m, n)(dd) *
                                         (*der_con.der_t)(l, m, n)(dd));
                    }
                // Dirac part
                for (int k = 1; k <= espace.get_ndim(); k++)
                    cmpder +=
                        0.5 * ((*p_dirac[dd]->der_t)(k)(dd) * (*der_con.val_t)(k, pos(0) + 1, pos(1) + 1)(dd) +
                               (*p_dirac[dd]->val_t)(k)(dd) * (*der_con.der_t)(k, pos(0) + 1, pos(1) + 1)(dd) -
                               (*p_met_con[dd]->der_t)(pos(0) + 1, k)(dd) * (*der_dirac.val_t)(k, pos(1) + 1)(dd) -
                               (*p_met_con[dd]->val_t)(pos(0) + 1, k)(dd) * (*der_dirac.der_t)(k, pos(1) + 1)(dd) -
                               (*p_met_con[dd]->der_t)(pos(1) + 1, k)(dd) * (*der_dirac.val_t)(k, pos(0) + 1)(dd) -
                               (*p_met_con[dd]->val_t)(pos(1) + 1, k)(dd) * (*der_dirac.der_t)(k, pos(0) + 1)(dd));
        ...
        /*
            ...
            Term_eq der_con (fmet.derive (COV, ' ', (*p_met_con[dd]))) ;
            bool doder = ((der_cov.der_t==nullptr) || (der_con.der_t==nullptr) || (dder_cov.der_t==nullptr)) ? false :
           true ;
            ...
            do {
                ...
                for (int k=1 ; k<=espace.get_ndim() ; k++)
                    ...
                    + (*p_met_con[dd]->val_t)(k,l)(dd)*(*dder_cov.der_t)(k,l, pos(0)+1, pos(1)+1)(dd)
                     ...
                     +(*der_con.val_t)(pos(0)+1, k, l)(dd) * (*der_cov.der_t)(k, pos(1)+1, l)(dd)
                          ...
                          - (*p_christo[dd]->der_t)(pos(0)+1,l,k)(dd)*(*p_christo[dd]->val_t)(pos(1)+1,k,l)(dd)
                          - (*p_christo[dd]->val_t)(pos(0)+1,l,k)(dd)*(*p_christo[dd]->der_t)(pos(1)+1,k,l)(dd) ;
                    }
    ...
    Term_eq Metric_conf::derive_flat(int type_der, char ind_der, const Term_eq& so) const
    {
    ...
    Term_eq Metric_conf::derive(int type_der, char ind_der, const Term_eq& so) const
    {
        ...
        for (int cmp = 0; cmp < so.val_t->get_valence(); cmp++) {
            ...
            std::unique_ptr<Term_eq> christ;
            if (need_sum)
                if (!doder)
                    christ = std::make_unique<Term_eq>(dd, auxi_christ.val_t->do_summation_one_dom(dd));
                else
                    christ = std::make_unique<Term_eq>(dd, auxi_christ.val_t->do_summation_one_dom(dd),
                                         auxi_christ.der_t->do_summation_one_dom(dd));
            else
                christ = std::make_unique<Term_eq>(auxi_christ);
    ...
    void Metric_conf::compute_dirac(int dd) const
    {
        if (p_met_con[dd] == nullptr)
            compute_con(dd);

        Array<int> type_ind(3);
        Tensor res_val(espace, 1, CON, basis);
        Tensor res_der(espace, 1, CON, basis);

        Term_eq flat_der(fmet.derive(COV, ' ', (*p_met_con[dd])));
        bool doder = (flat_der.der_t == nullptr) ? false : true;
        ...
        do {
            ...
            for (int l = 1; l <= espace.get_ndim(); l++)
                cmpval += (*flat_der.val_t)(l, l, pos(0) + 1)(dd);
            ...
            if (doder) {
                ...
                cmpder = 0;
                for (int l = 1; l <= espace.get_ndim(); l++)
                    cmpder += (*flat_der.der_t)(l, l, pos(0) + 1)(dd);
                res_der.set(pos).set_domain(dd) = cmpder;
            }
        } while (pos.inc());
        ...
        if (!doder) {
            if (p_dirac[dd] == nullptr)
                p_dirac[dd] = std::make_unique<Term_eq>(dd, res_val);
            else
                *p_dirac[dd] = Term_eq(dd, res_val);
        } else {
            if (p_dirac[dd] == nullptr)
                p_dirac[dd] = std::make_unique<Term_eq>(dd, res_val, res_der);
            else
                *p_dirac[dd] = Term_eq(dd, res_val, res_der);
        }
    }

    void Metric_conf::set_system(System_of_eqs& ss, const char* name_met)
    {
