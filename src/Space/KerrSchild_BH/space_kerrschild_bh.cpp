...
namespace Kadath
{
    Space_KerrSchild_bh::Space_KerrSchild_bh(int ttype, const Point& center, const Dim_array& res,
    ...
    Space_KerrSchild_bh::Space_KerrSchild_bh(BinarySource& source)
    {
        ...
        domains[1] = new Domain_shell_outer_adapted(*this, 1, source);
        domains[2] = new Domain_shell_inner_adapted(*this, 2, source);
    ...
    Space_KerrSchild_bh::~Space_KerrSchild_bh()
    {
        const Domain_shell_outer_adapted* pouter_1 = dynamic_cast<const Domain_shell_outer_adapted*>(domains[1]);
        pouter_1->del_deriv();
        const Domain_shell_inner_adapted* pinner_1 = dynamic_cast<const Domain_shell_inner_adapted*>(domains[2]);
    ...
    void Space_KerrSchild_bh::save(BinarySink& sink) const
    {
    ...
    int Space_KerrSchild_bh::nbr_unknowns_from_variable_domains() const
    {
        return domains[2]->nbr_unknowns_from_adapted();
    }

    void Space_KerrSchild_bh::affecte_coef_to_variable_domains(int& pos, int cc, Array<int>& zedoms) const
    {
    ...
    void Space_KerrSchild_bh::xx_to_ders_variable_domains(const Array<double>& xx, int& conte) const
    {
        int old_conte = conte;
    ...
    void Space_KerrSchild_bh::xx_to_vars_variable_domains(System_of_eqs* sys, const Array<double>& xx, int& pos) const
    {
    ...
    Array<int> Space_KerrSchild_bh::get_indices_matching_non_std(int dom, int bound) const
    {
