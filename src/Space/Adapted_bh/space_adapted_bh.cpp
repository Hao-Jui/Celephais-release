...
namespace Kadath
{
    Space_adapted_bh::Space_adapted_bh(int ttype, const Point& center, const Dim_array& res,
    ...
    Space_adapted_bh::Space_adapted_bh(BinarySource& source)
    {
    ...
    void Space_adapted_bh::save(BinarySink& sink) const
    {
