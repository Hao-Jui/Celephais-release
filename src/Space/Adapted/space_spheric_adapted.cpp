...
namespace Kadath
{
    Space_spheric_adapted::Space_spheric_adapted(int ttype, const Point& center, const Dim_array& res,
    ...
    Space_spheric_adapted::Space_spheric_adapted(BinarySource& source)
    {
    ...
    void Space_spheric_adapted::save(BinarySink& sink) const
    {
