...
namespace Kadath
{
    void Space_spheric_adapted_nosym::add_eq_int(System_of_eqs& sys, const int dom, const int bc, const char* eq)
    {
    ...
    void Space_spheric_adapted_nosym::add_eq_int_inf(System_of_eqs& sys, const char* nom)
    {
    ...
    void Space_spheric_adapted_nosym::add_eq_int_volume(System_of_eqs& sys, int nz, const char* nom)
    {
    ...
    void Space_spheric_adapted_nosym::add_eq(System_of_eqs& sys, const char* eq, const char* rac, const char* rac_der,
