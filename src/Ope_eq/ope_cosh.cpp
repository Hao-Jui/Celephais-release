...
namespace Kadath
{
    Ope_cosh::Ope_cosh(const System_of_eqs* zesys, Ope_eq* target) : Ope_eq(zesys, target->get_dom(), 1)
    {
    ...
    Term_eq Ope_cosh::action() const
    {
        ...
        return detail::apply_scalar_unary_operator(
            ...
            target,
            "Ope_cosh",
            [](const auto& value) { return cosh(value); },
            [](const auto& derivative, const auto& value) { return derivative * sinh(value); });
    }
} // namespace Kadath
