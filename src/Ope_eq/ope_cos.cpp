...
namespace Kadath
{
    Ope_cos::Ope_cos(const System_of_eqs* zesys, Ope_eq* target) : Ope_eq(zesys, target->get_dom(), 1)
    {
    ...
    Term_eq Ope_cos::action() const
    {
        ...
        return detail::apply_scalar_unary_operator(
            ...
            [](const auto& derivative, const auto& value) { return -derivative * sin(value); });
    }
} // namespace Kadath
