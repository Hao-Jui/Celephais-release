...
namespace Kadath
{
    Ope_log::Ope_log(const System_of_eqs* zesys, Ope_eq* target) : Ope_eq(zesys, target->get_dom(), 1)
    {
    ...
    Term_eq Ope_log::action() const
    {
        ...
        return detail::apply_scalar_unary_operator(
            ...
            [](const auto& derivative, const auto& value) { return derivative / value; });
    }
} // namespace Kadath
